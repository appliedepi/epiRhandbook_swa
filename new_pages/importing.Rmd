...
* Matukio mahususi ya uingizaji, kama vile:  
  ...
  * Na APIs  
  * Kuingiza faili ya *hivi karibuni*  
...
Unapoingiza "dataset" katika R, kwa ujumla unaunda kipengee kipya cha *data frame* katika mazingira yako ya R na kukifafanua kama faili iliyoagizwa kutoka nje (kwa mfano, Excel, CSV, TSV, RDS) ambayo iko katika saraka za folda yako katika njia/anwani fulani ya faili.
