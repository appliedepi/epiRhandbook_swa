...
```{r, eval=F, echo=F}
my_function <- function( HOJA HAPA ){ MSIMBO HAPA }
```
...
Je, una wasiwasi kuhusu virusi na usalama unapopakua kifurushi kutoka CRAN? Soma [kurasa hii](https://support.rstudio.com/hc/en-us/articles/360042593974-R-and-R-Package-Security) kuhusu somo hili.
