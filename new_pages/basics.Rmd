...
Safu wima katika mkusanyiko wa data pia ni vitu na vinaweza kufafanuliwa, kuandikwa zaidi, na kuundwa kama ilivyoelezwa hapa chini katika sehemu ya Safu wima.
...
**Vipengee vinaweza kuwa kipande kimoja cha data (k.m. my_number \<- 24), au vinaweza kujumuisha data iliyopangwa.**

TMchoro ulio hapa chini umekopwa kutoka kwa mafunzo haya ya [mtandaoni ya R](http://venus.ifca.unican.es/Rintro/dataStruct.html). Inaonyesha baadhi ya miundo ya kawaida ya data na majina yao. Haijajumuishwa katika picha hii ni data ya anga, ambayo inajadiliwa katika ukurasa wa misingi ya GIS.
...
+------------------+-----------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| Common structure | Maelezo                                                                                 | Mfano                                                                      |
+==================+=========================================================================================+============================================================================+
| Vectors          | Chombo cha mlolongo wa vitu vya umoja, vyote vya darasa moja (k.m. nambari, herufi).    | "Vigezo" (safu wima) katika fremu za data ni vekta (k.m. safu wima_miaka). |
+------------------+-----------------------------------------------------------------------------------------+----------------------------------------------------------------------------+
| Data Frames      |     Vekta (k.m. safuwima) ambazo zimefungwa pamoja ambazo zote zina idadi sawa ya safu. | `linelist` ni fremu ya data.                                               |
+------------------+-----------------------------------------------------------------------------------------+----------------------------------------------------------------------------+

Kumbuka kuwa kuunda vekta ambayo "inasimama peke yake" (sio sehemu ya fremu ya data) chaguo la kukokotoa c() linatumika kuchanganya vipengele tofauti. Kwa mfano, ikiwa unaunda vekta ya rangi ukubwa wa rangi ya kiwanja: vekta_ya_rangi \<- c("bluu", "red2", "chungwa", "kijivu").
...
| list       | Orodha ni kama vekta, lakini inashikilia vitu vingine ambavyo vinaweza kuwa aina zingine tofauti                                                                                                    | Orodha inaweza kushikilia nambari moja, na mfumo wa data, na vekta, na hata orodha nyingine ndani yake!  |
