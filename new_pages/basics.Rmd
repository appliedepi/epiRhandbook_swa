...
**Masomo (Objects)** - Kila kitu unachohifadhi katika R - seti za data, kifofautishi, orodha ya majina ya vijiji, jumla ya idadi ya watu, hata matokeo kama vile grafu - ni *masomo* ambayo *yamepewa majina* na *yanayoweza kurejelewa* katika amri za baadaye. Soma zaidi [katika sehemu ya Masomo](#objects).

**Vikokotozi (Functions)** - Kikokotozi ni kitenda kazi cha msimbo ambao unachukua ingizo na kurejesha matokeo yaliyobadilishwa. Soma zaidi [katika sehemu ya Kazi](#functions).

**Vifurushi (Packages)** - Kifurushi cha R ni fungu la vikokotozi linaloweza kushirikishwa/kugawa. Soma zaidi [katika sehemu ya Vifurushi](#packages).
...
Kidirisha hiki, kwa asili huwa katika sehemu ya juu kulia, mara nyingi hutumika kuona muhtasari mfupi wa [Masomo (Objects)](#objects) katika Mazingira ya R (R environment) katika kipindi cha sasa. Masomo haya huweza kujumuisha seti za data zilizoingizwa, zilizorekebishwa au kuundwa, vigezo ulivyofafanua (k.m. wiki maalum ya epi kwa uchanganuzi), au vekta au orodha ambazo umefafanua wakati wa uchanganuzi (k.m. majina ya maeneo). Unaweza kubofya mshale karibu na jina la fremu ya data ili kuona vigeuzo vyake.
...
[***KIDOKEZO:*** Tumia ufunguo wako 'Tab' unapoandika ili kupata vidokezo kamilifu vya kiotomatiki vya RStudio. Hii inaweza kuzuia makosa ya kiuandishi. Bonyeza Tab unapoandika ili kutoa menyu kunjuzi ya vikokotozi na vipengele vinavyowezekana, kulingana na ulichokwishandika.]{style="color: darkgreen;"}

<!-- ======================================================= -->

## Vikokotozi {#functions}

Vikokotozi Functions are at the core of using R. Functions are how you perform tasks and operations. Many functions come installed with R, many more are available for download in *packages* (explained in the [packages](#packages) section), and you can even write your own custom functions!
