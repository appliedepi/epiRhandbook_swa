...
Njia ya kawaida, fanisi na isiyo na matatizo ya kutumia R ni kwa kuunganisha vipengele vitatu. Mradi mmoja wa kazi unaojitegeme unahifadhiwa ndani ya mradi mmoja wa R. Kila kipengele kinaelezwa katika sehemu hapa chini.

1)  **Mradi wa R**

    -   Mazingira ya kufanya kazi yanayojitosheleza yenye folda za data, hati, matokeo, n.k.\

2)  Kifurushi cha **hapa** cha njia za faili za jamaa

    -   Njia za faili zimeandikwa kuhusiana na folda ya mizizi ya mradi wa R - tazama [Ingiza na Hamisha] kwa habari zaidi
...
Kutengeneza Mradi wa R, Chagua "*New Project*" kutoka kwa menyu ya Faili ya Rstudio.
...
*Kuhamisha the R `linelist` as "my_linelist.rds" to the "clean" folder within the "data" folder in your R project.*   
